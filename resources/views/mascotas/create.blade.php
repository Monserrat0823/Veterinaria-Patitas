        ...
        <x-tab-content tab="mascota">
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6 p-2">
            <div>
              ...
              <x-wire-input name="nombre" placeholder="Ej: Max, Luna..." value="{{ old('nombre') }}" />
            </div>
            ...
            <div>
              ...
              <x-wire-input name="especie" placeholder="Ej: Perro, Gato, Conejo..." value="{{ old('especie') }}" />
            </div>
            ...
            <div>
              ...
              <select name="sexo" class="w-full rounded-lg border border-gray-300 bg-white px-3 py-2 text-sm focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500 shadow-sm">
        ...
        <x-tab-content tab="propietario">
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6 p-2">
            <div>
              ...
              <x-wire-input name="dueno_nombre" placeholder="Nombre completo" value="{{ old('dueno_nombre') }}" />
            </div>
