...
">  
  <x-wire-card>
    ...
    <form action="{{route('admin.users.store')}}" method="POST">
      ...
      <x-wire-input label="Correo Electronico" name="email" type="email" placeholder="ejemplo@dominio.com" required autocomplete="email" :value="old('email')"></x-wire-input>
      ...
      <x-wire-input label="Número de ID" name="id_number" placeholder="Ej:1234" autocomplete="off" required inputmode="numeric" :value="old('id_number')"></x-wire-input>
